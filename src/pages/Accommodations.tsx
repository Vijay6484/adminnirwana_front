...
const Accommodations: React.FC = () => {
  ...
  const fetchAccommodations = async (filterParams: Partial<Filters> = {}) => {
    ...
    try {
      ...
      const result = (
        await api.get<ApiResponse>("/admin/properties/accommodations", {
  ...
  const handleDelete = async (id: string | number) => {
    ...
    try {
      await api.delete(`/admin/properties/accommodations/${id}`);
  ...
  // Toggle availability
  const toggleAvailability = async (id: string | number, currentStatus: boolean) => {
    // Commented out API call - using mock toggle
    try {
      await api.patch(
        `/admin/properties/accommodations/${id}/toggle-availability`,
            ...
            >
              <div className="relative h-48 flex-shrink-0">
                ...
                <div className="absolute top-2 right-2">
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium cursor-pointer transition-colors ${accommodation.available
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 flex space-x-2">
                  <button
                    ...
                    className="flex-1 inline-flex justify-center items-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex justify-center items-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-blue-700 bg-white hover:bg-blue-50 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-colors"
                  >
