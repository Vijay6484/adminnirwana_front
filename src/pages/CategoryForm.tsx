...
const CategoryForm: React.FC = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://adminnirwana-back-1.onrender.com/admin/categories');
  ...
  const fetchCategory = async () => {
    try {
      setLoading(true);
      const response = await fetch(`https://adminnirwana-back-1.onrender.com/admin/categories/${id}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = isEditing
        ? `https://adminnirwana-back-1.onrender.com/admin/categories/${id}`
        : 'https://adminnirwana-back-1.onrender.com/admin/categories';
